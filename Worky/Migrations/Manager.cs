...
public partial class Manager
{
    ...
    [StringLength(100)] public string second_name { get; set; } = null!;

    [StringLength(50)] public string first_name { get; set; } = null!;

    [StringLength(50)] public string surname { get; set; } = null!;

    [Column(TypeName = "smallint(6)")] public short age { get; set; }
