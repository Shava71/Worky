...
public class OldAuthorizationController : Controller
{
    ...
    ILogger<OldAuthorizationController> _logger;
    IJwtService _jwtService;


    public OldAuthorizationController(WorkyDbContext dbContext, ILogger<OldAuthorizationController> logger,
