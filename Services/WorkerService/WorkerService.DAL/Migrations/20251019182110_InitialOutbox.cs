        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    education_id = table.Column<decimal>(type: "numeric(20,0)", nullable: true),
                    income_date = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    wantedSalary = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_Resume_Worker_worker_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    typeOfActivity_id = table.Column<decimal>(type: "numeric(20,0)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Resume_filter", x => x.filter_id);
                    table.ForeignKey(
                        name: "FK_Resume_filter_Resume_resume_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Resume_worker_id",
                table: "Resume",
                column: "worker_id");

            migrationBuilder.CreateIndex(
                name: "IX_Resume_filter_resume_id_typeOfActivity_id",
                table: "Resume_filter",
                columns: new[] { "resume_id", "typeOfActivity_id" },
                unique: true);
        }
